...
class JNIThread private constructor(lockIn: GameLock) : Thread(), AutoCloseable {
    ...
    inner class GameStateInfo() {
        ...
        constructor(other: GameStateInfo): this()
        {
            visTileCount = other.visTileCount
            trayVisState = other.trayVisState
            nPendingMessages = other.nPendingMessages
            canHint = other.canHint
            canUndo = other.canUndo
            canRedo = other.canRedo
            inTrade = other.inTrade
            tradeTilesSelected = other.tradeTilesSelected
            canChat = other.canChat
            canShuffle = other.canShuffle
            curTurnSelected = other.curTurnSelected
            canHideRack = other.canHideRack
            canTrade = other.canTrade
            canPause = other.canPause
            canUnpause = other.canUnpause
        }
    }
